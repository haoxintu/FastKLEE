...
namespace
{
  ...
  private:
    ...
    void identifyDifferentKindsOfUnsafePointers() {
		...
		int	unsafeStackInstCount = 0;
		int unsafeStackNonLocalInstCount = 0;
        ...
        errs() << NORMAL << "\n";
        errs() << BLUE << "Total Unsafe Stack Pointer Number: " << RED << unsafeStackPointerCount << NORMAL << "\n";
