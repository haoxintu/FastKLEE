# Install script for directory: /home/haoxin/disk-smu/research/klee-ccured/runtime/Runtest
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/haoxin/disk-smu/research/klee-ccured/build/lib/libkleeRuntest.so.1.0")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/haoxin/disk-smu/research/klee-ccured/build/lib/libkleeRuntest.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so")
    if(CMAKE_INSTALL_DO_STRIP)
